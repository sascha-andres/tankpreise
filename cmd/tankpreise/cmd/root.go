...
var rootCmd = &cobra.Command{
	Use:   "tankpreise",
	Short: "get prices for gas stations in Germany",
	Long: `This application is a wrapper for https://creativecommons.tankerkoenig.de/
and allow to query for closest gas stations along with
prices.`,
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".tankpreise" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".tankpreise")
	}
